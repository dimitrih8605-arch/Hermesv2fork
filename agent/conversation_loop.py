    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                # ── Interim message dedup (upstream) ────────────────────────
                ...
                if _violation_note:
                    ...
                    setattr(agent, _enforce_key, 0)

                # ── Mixed batch: error-result invalid calls (upstream) ─────
                ...
                # ── Kanban worker terminal-tool stop guard (upstream) ────
                ...
                # ── Raiden ending review (fork — runs after kanban guard) ─
                try:
